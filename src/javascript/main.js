...
import Weapon, { AimedWeapon, AuraWeapon, ExplosiveWeapon } from "./weapon.js";
...
player.addWeapon(new AimedWeapon(player, game.inputHandler.cursorWorldPos, 5, 250, 20, 0.2, "#ff9900"));
player.addWeapon(new AuraWeapon(player, 2, 100, 0.1, "#00ccff99"));
player.addWeapon(new ExplosiveWeapon(player, 10, 150, 20, 1, 100));
game.addSpawner();
